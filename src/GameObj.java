...
public abstract class GameObj {
    ...
    private LinkedList<Point> gameObj;
    ...
    public GameObj(
        ...
        this.gameObj = new LinkedList<>();
        this.gameObj.addFirst(new Point(px, py));
    }
    ...
    public boolean intersects(GameObj that) {
        for (Point p : this.gameObj) {
            if (p.x + this.width >= that.px
                    && p.y + this.height >= that.py
    ...
    /**
     * Adds GameObj to random position on board.
     */
    public void add() {
        int randomX = (int) (Math.random() * this.maxX);
        int randomY = (int) (Math.random() * this.maxY);
        this.gameObj.add(new Point(randomX, randomY));
    }

    /**
     * Removes GameObj at position i.
     */
    public void remove(int i) {
        this.gameObj.remove(i);
    }
}